		...
		void InitializeComponent(void)
		{
			...
			this->GeneralMenuStrip->Items->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(5) {
				this->сохранитьToolStripMenuItem,
					this->сохранитьКакToolStripMenuItem, this->новыйТестToolStripMenuItem, this->настройкиКурсаToolStripMenuItem, this->выйтиToolStripMenuItem
			});
			...
			this->выйтиToolStripMenuItem->Size = System::Drawing::Size(103, 20);
			this->выйтиToolStripMenuItem->Text = L"Выйти из курса";
			this->выйтиToolStripMenuItem->Click += gcnew System::EventHandler(this, &TeacherCourseView::выйтиToolStripMenuItem_Click);
			// 
			// SaveCourseDialog
			// 
