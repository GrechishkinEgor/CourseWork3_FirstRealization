...
{
	if (System::Windows::Forms::MessageBox::Show("Âû óâåðåíû, ÷òî õîòèòå áåçâîçâðàòíî óäàëèòü òåñò?", "Óäàëåíèå òåñòà", System::Windows::Forms::MessageBoxButtons::OKCancel, System::Windows::Forms::MessageBoxIcon::Exclamation)
