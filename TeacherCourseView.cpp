...
CourseWork::TeacherCourseView::TeacherCourseView(void)
{
    ...
    {
        ÒÓı‡ÌËÚ¸ToolStripMenuItem->Enabled = false;
        //ÒÓı‡ÌËÚ¸ ‡ÍToolStripMenuItem->Enabled = false;
        ÌÓ‚˚È“ÂÒÚToolStripMenuItem->Enabled = false;
    }
    return;
}

System::Void CourseWork::TeacherCourseView::Ì‡ÒÚÓÈÍË ÛÒ‡ToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e)
{
...
System::Void CourseWork::TeacherCourseView::ÒÓı‡ÌËÚ¸ToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e)
{
...
System::Void CourseWork::TeacherCourseView::ÒÓı‡ÌËÚ¸ ‡ÍToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e)
{
    if (SaveCourseDialog->ShowDialog() == System::Windows::Forms::DialogResult::OK)
        CurrentApplicationContext::SaveCourse(SaveCourseDialog->FileName);
}

System::Void CourseWork::TeacherCourseView::ÌÓ‚˚È“ÂÒÚToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e)
{
...
System::Void CourseWork::TeacherCourseView::‚˚ÈÚËToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e)
{
